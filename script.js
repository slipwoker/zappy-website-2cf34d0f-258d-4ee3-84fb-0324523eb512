            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    .catch(() => {
                        ...
                        errorMessage.style.cssText = 'color: #dc3545; padding: 1rem; background: #f8d7da; border-radius: 4px; margin-top: 1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2cf34d0f-258d-4ee3-84fb-0324523eb512',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2cf34d0f-258d-4ee3-84fb-0324523eb512';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2cf34d0f-258d-4ee3-84fb-0324523eb512';
